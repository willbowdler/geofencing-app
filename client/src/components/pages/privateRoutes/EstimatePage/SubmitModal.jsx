...
function SubmitModal({ setSubModalShow, emailData }) {
  ...
  const submitMessage =
    'Submitting this estimate will send an email to our office staff indicating that you are interesting in getting an official quote from us. If you submit, we will reach out to you shortly during our normal business hours. You can call us as well if you would like. Are you sure you would like to submit?'
